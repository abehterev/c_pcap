...
/** 
 * Given a pointer to an array of bytes, return a double indicating the
 ...
 * SIGSEGV.
 */
double    shannon_H(const char*, unsigned long);
...
double    get_max_entropy(void);

/** Returns the ratio of entropy to maxentropy */
double    get_entropy_ratio(void);
